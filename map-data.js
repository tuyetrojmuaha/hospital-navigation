...
const HOSPITAL_MAP = {
  nodes: [
    ...
    // Đây KHÔNG phải nơi đến, chỉ là điểm gãy của lối đi thật, đặt TẠI ĐÚNG các hàng mũi tên
    // đỏ hai chiều (↕) trên sơ đồ gốc — đó là ký hiệu lối đi bộ được phép qua trên bản vẽ.
    // Toạ độ được xác định bằng cách dò màu đỏ trên ảnh gốc rồi quy đổi về hệ 1000x1298.
    // Không hiện trong danh sách tìm kiếm, không có mã QR.
    { id: "P_N",     name: "Băng qua lối Bắc (gần cổng 1B, cạnh nhà 01/05)", x: 278, y: 308,  floor: 1, isWaypoint: true },
    { id: "P_NE",    name: "Lối đi phía Bắc (gần cổng 1A)",                  x: 430, y: 320,  floor: 1, isWaypoint: true },
    { id: "P_GATECC",name: "Băng qua ngay cổng Cấp cứu",                    x: 140, y: 489,  floor: 1, isWaypoint: true },
    { id: "P_W1",    name: "Băng qua giữa nhà 05/08 và bãi xe",             x: 252, y: 510,  floor: 1, isWaypoint: true },
    { id: "P_C1",    name: "Lối đi Trung tâm 1 (giữa nhà 03/04 và 06)",     x: 400, y: 460,  floor: 1, isWaypoint: true },
    { id: "P_E1",    name: "Lối đi Đông 1",                                 x: 560, y: 460,  floor: 1, isWaypoint: true },
    { id: "P_C1B",   name: "Băng qua giữa nhà 06 và khu 09",                x: 456, y: 549,  floor: 1, isWaypoint: true },
    { id: "P_W2",    name: "Lối đi cạnh Toà Tháp đôi",                      x: 200, y: 650,  floor: 1, isWaypoint: true },
    { id: "P_C2",    name: "Lối đi qua hàng cây (giữa nhà 08 và 09)",       x: 376, y: 600,  floor: 1, isWaypoint: true },
    { id: "P_E2",    name: "Lối đi Đông 2 (gần Nhà thể thao 1)",            x: 580, y: 650,  floor: 1, isWaypoint: true },
    { id: "P_W2B",   name: "Băng qua giữa nhà 08 và 09/10",                 x: 318, y: 702,  floor: 1, isWaypoint: true },
    { id: "P_C3",    name: "Lối đi Trung tâm 3 (gần nhà 10)",               x: 392, y: 781,  floor: 1, isWaypoint: true },
    { id: "P_E3",    name: "Lối đi Đông 3 (gần Nhà thể thao 2)",            x: 580, y: 750,  floor: 1, isWaypoint: true },
    { id: "P_W3B",   name: "Băng qua gần Sảnh B (nhà 08)",                  x: 185, y: 792,  floor: 1, isWaypoint: true },
    { id: "P_W3",    name: "Lối đi Tây 3 (gần Nhà lưu trữ)",                x: 160, y: 852,  floor: 1, isWaypoint: true },
    { id: "P_S1",    name: "Lối đi Nam 1 (gần Viện Truyền nhiễm)",          x: 300, y: 950,  floor: 1, isWaypoint: true },
    { id: "P_SX",    name: "Băng qua giữa Viện Truyền nhiễm và Nhà tang lễ",x: 300, y: 1017, floor: 1, isWaypoint: true },
  ...
  edges: [
    ...
    { from: "P_W1",    to: "P_C1" },
    { from: "P_C1",    to: "P_E1" },
    { from: "P_W1",    to: "P_GATECC" },
    { from: "P_GATECC",to: "P_W2" },
    { from: "P_C1",    to: "P_C1B" },
    { from: "P_C1B",   to: "P_C2" },
    { from: "P_E1",    to: "P_E2" },
    { from: "P_W2",    to: "P_C2" },
