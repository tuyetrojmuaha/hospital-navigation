...
const HOSPITAL_MAP = {
  nodes: [
    ...
    { id: "B01_F1_TT", name: "Khu thanh toán (Nhà N1A, Tầng 1)", x: 376, y: 398, floor: 1, isDestination: true, isTransitPoint: true },
    ...
    { id: "B08_CAPCUU", name: "Khu Cấp cứu C1.3 (Toà Tháp đôi)", x: 142, y: 566, floor: 1, isDestination: true, isTransitPoint: true },
    { id: "B08_KHAMA", name: "Khu khám A - Bộ đội hưu và Viettel (Toà Tháp đôi)", x: 209, y: 592, floor: 1, isDestination: true, isTransitPoint: true },
    { id: "B08_NGOAIKHOA", name: "Nhà Ngoại khoa (Toà Tháp đôi)", x: 237, y: 593, floor: 1, isDestination: true, isTransitPoint: true },
    ...
    { id: "B08_KHAMB", name: "Khu khám B, khu thanh toán (Toà Tháp đôi)", x: 209, y: 729, floor: 1, isDestination: true, isTransitPoint: true },
    { id: "B08_NHATHUOC1", name: "Nhà thuốc số 1 (Toà Tháp đôi)", x: 144, y: 717, floor: 1, isDestination: true, isTransitPoint: true },
    { id: "B08_NOIKHOA", name: "Nhà Nội khoa (Toà Tháp đôi)", x: 237, y: 733, floor: 1, isDestination: true, isTransitPoint: true },
